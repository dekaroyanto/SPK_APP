...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold"><i class="fas fa-fw fa-edit"></i> Edit Data User</h6>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input autocomplete="off" type="email" name="email" value="{{ $user->email }}" required
                            class="form-control" />
                    </div>

                    <div class="form-group col-md-6">
                        <label class="font-weight-bold">Username</label>
                        <input autocomplete="off" type="text" name="username" value="{{ $user->username }}" required
                            class="form-control" />
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input autocomplete="off" type="text" name="nama" value="{{ $user->nama }}" required
                            class="form-control" />
                    </div>
