...
<div class="card shadow mb-4">
    <div class="w3-bar">
        ...
        <a href="{{ url('Perhitungan/matrixkeputusan') }}" class="w3-bar-item w3-button w3-hide-small">Matriks Keputusan (X)</a>
...
{{-- <ul class="nav nav-tabs mb-5" id="myTab" role="tablist">
    <li class="nav-item">
        <a class="nav-link active" id="bobot-tab" data-toggle="tab" href="{{ url('Perhitungan') }}" role="tab" aria-controls="bobot" aria-selected="true">Bobot Kriteria</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="matriks-x-tab" data-toggle="tab" href="{{ url('Perhitungan/matrixkeputusan') }}" role="tab" aria-controls="matriks-x" aria-selected="false">Matriks Keputusan (X)</a>
    </li>
    <li class="nav-item">
