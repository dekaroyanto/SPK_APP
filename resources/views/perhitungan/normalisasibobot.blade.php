...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <form action="{{ url('Perhitungan/normalisasibobot') }}" method="GET">
                ...
                <div class="form-group col-md-4">
                    <div style="display: flex; align-items: center;" class="gap-1">
                        ...
                        <a href="{{ url('Perhitungan/normalisasibobot') }}" class="btn btn-danger ml-2">Reset</a>
                    </div>
                </div>
            </form>
        </div>
                ...
                <table class="table table-striped text-sm" id="table1">
                    <thead class="text-center">
                        <tr align="center">
                            ...
                            <th width="10%">Nama</th>
                            <th class="text-center" width="15%">Divisi</th>
