            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input autocomplete="off" type="email" name="email" value="{{ $profile->email }}" required
                            class="form-control">
                    </div>

                    <div class="form-group col-md-6">
                        <label class="font-weight-bold">Username</label>
                        <input autocomplete="off" type="text" name="username" value="{{ $profile->username }}" required
                            class="form-control">
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input autocomplete="off" type="text" name="nama" value="{{ $profile->nama }}" required
                            class="form-control">
                    </div>
                </div>
            </div>
