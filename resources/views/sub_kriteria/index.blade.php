...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <div class="d-sm-flex align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold"><i class="fa fa-table"></i> {{ $key->keterangan }} ({{ $key->kode_kriteria }})</h6>

            <a href="#tambah{{ $key->id_kriteria }}" data-bs-toggle="modal" class="btn btn-sm btn-primary"> <i class="fa fa-plus"></i> Tambah Data </a>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <a href="#editsk{{ $key->id_sub_kriteria }}" data-bs-toggle="modal" title="Edit Data" class="btn btn-warning btn-sm"><i
                                ...
                                <button data-toggle="tooltip" data-placement="bottom" title="Hapus Data" onclick="confirmDelete('{{ url('SubKriteria/destroy/'.$key->id_sub_kriteria) }}')" class="btn btn-danger btn-sm"><i class="bi bi-trash-fill"></i></button>
                            </div>
                        </td>
                    </tr>
