...
--
-- Host: localhost
-- Generation Time: May 09, 2024 at 05:46 PM
...
(56, 'Pengalaman', 'K1', 0.456667, '1'),
(57, 'Usia', 'K2', 0.256667, '2'),
(58, 'Tes Wawancara', 'K3', 0.156667, '3'),
(59, 'Tes Kemampuan', 'K4', 0.09, '4'),
...
(293, 59, 'Sangat Buruk', 1),
(294, 59, 'Buruk', 2),
(295, 59, 'Cukup', 3),
(296, 59, 'Bagus', 4),
(297, 59, 'Sangat Bagus', 5),
(298, 60, 'SD', 1),
(299, 60, 'SMP', 2),
(300, 60, 'SMA', 3),
(301, 60, 'D3', 4),
...
(1, 1, 'Admin Update', 'admin@gmail.com', 'admin', '21232f297a57a5a743894a0e4a801fc3'),
...
--
ALTER TABLE `alternatif`
  MODIFY `id_alternatif` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
...
--
ALTER TABLE `penilaian`
  MODIFY `id_penilaian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=494;
